...
void Vulkan_App::createDepthResources() {
...
VkImageView Vulkan_App::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
void Vulkan_App::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
...
void Vulkan_App::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkCommandBuffer Vulkan_App::beginSingleTimeCommands() {
...
void Vulkan_App::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void Vulkan_App::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
...
void Vulkan_App::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void Vulkan_App::updateUniformBuffer(uint32_t currentImage) {
...
void Vulkan_App::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
...
VkPresentModeKHR Vulkan_App::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkSurfaceFormatKHR Vulkan_App::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
